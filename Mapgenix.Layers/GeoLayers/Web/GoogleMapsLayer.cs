...
namespace Mapgenix.Layers
{
    ...
    public class GoogleMapsLayer : BaseLayer
    {
        ...
        private GoogleMapsLayerImageCache imageCache;
        ...
        public GoogleMapsLayer(String licenseKey, String cacheDirectory, String clientId, String privateKey, WebProxy webProxy)
            : base()
        {
            this.licenseKey = licenseKey;
            imageCache = new GoogleMapsLayerImageCache();
        ...
        public Bitmap NoDataTileImage
        {
            get
            {
                ...
                return (Bitmap)noDataTileImage.Clone();
            }
        ...
        private void ProcessMultiTileMode(BaseGeoCanvas canvas)
        {
            ...
            try
            {
                ...
                if (currentExtent.UpperLeftPoint.X < -180 && currentExtent.UpperRightPoint.X > -180)
                {
                    ...
                    // Merge two images
                    resultImage = new Bitmap((int)canvas.Width, (int)canvas.Height);
