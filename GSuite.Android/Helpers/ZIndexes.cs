namespace Mapgenix.GSuite.Android
{
    internal static class ZIndexes
    {
        ...
        internal const int EditInteractiveOverlay = 601;
        internal const int TrackZoomingRectangle = 701;
        internal const int AdornmentOverlay = 801;
        internal const int MarkerOverlay = 901;
        internal const int PopupOverlay = 902;
    }
}
