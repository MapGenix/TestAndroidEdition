...
namespace Mapgenix.GSuite.Android
{
    ...
    public abstract class BaseTileCache
    {
        ...
        [NonSerialized]
        private Bitmap _loadingTileImage;

        [NonSerialized]
        private Bitmap _noDataTileImage;
        ...
        public Bitmap NoDataTileImage
        {
            get
            {
                ...
                return Bitmap.CreateBitmap(256, 256, null);
            }
        }
        ...
        public Bitmap LoadingTileImage
        {
            get
            {
                ...
                {
                    //_loadingTileImage = GetCompressedOrStretchedImage(Resources.LoadingTile, _tileMatrix.TileWidth, _tileMatrix.TileHeight);
                }
            ...
            RectangleShape tileExtent, int tileImageWidth, int tileImageHeight)
        {
            ...
            if (sourceImage != null)
            {
                ...
                resultBitmap = Bitmap.CreateBitmap(tileImageWidth, tileImageHeight, null);


                using (var graphics = new NativeAndroid.Graphics.Canvas(resultBitmap))
                {
                    graphics.DrawBitmap(sourceImage, -(int)Math.Round(upperLeftPoint.X),
                        -(int)Math.Round(upperLeftPoint.Y), null);
                }
            }
