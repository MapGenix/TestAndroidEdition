...
namespace Mapgenix.GSuite.Android
{
    internal class HEREMapsAndroidLayer : BaseLayer
    {
        ...
        private HEREMapsAndroidLayerImageCache _imageCache = new HEREMapsAndroidLayerImageCache();
        ...
        public HEREMapsAndroidLayer() :
            this(String.Empty, String.Empty, HEREMapsMapType.Normal, String.Empty, HEREMapsPictureFormat.Png, null)
        { }
        public HEREMapsAndroidLayer(string appID, string appCode) :
            this(appID, appCode, HEREMapsMapType.Normal, String.Empty, HEREMapsPictureFormat.Png, null)
        { }
        public HEREMapsAndroidLayer(string appID, string appCode, HEREMapsMapType mapType) :
            this(appID, appCode, mapType, String.Empty, HEREMapsPictureFormat.Png, null)
        { }
        public HEREMapsAndroidLayer(string appID, string appCode, HEREMapsMapType mapType, string cacheDirectory) :
            this(appID, appCode, mapType, cacheDirectory, HEREMapsPictureFormat.Png, null)
        { }
        public HEREMapsAndroidLayer(string appID, string appCode, HEREMapsMapType mapType, string cacheDirectory, HEREMapsPictureFormat pictureFormat) : 
            this(appID, appCode, mapType, cacheDirectory, pictureFormat, null)
        { }

        public HEREMapsAndroidLayer(string appID, string appCode, HEREMapsMapType mapType, string cacheDirectory, HEREMapsPictureFormat pictureFormat, WebProxy webProxy)
        {
            this.IsVisible = true;
            this._mapType = mapType;
            this._tileMode = HEREMapsTileMode.SingleTile;
            ...
            RequestBuilder = new HEREMapsAndroidRequestBuilder
            {
                AppID = appID,
                AppCode = appCode,
                WebProxy = webProxy
        ...
        internal HEREMapsAndroidRequestBuilder RequestBuilder { get; set; }
        ...
        private void SingleTileDrawCore(BaseGeoCanvas canvas, BaseProjection projection, HEREMapsPictureFormat pictureFormat)
        {
            ...
            {
                image = _imageCache.GetCacheImage(_zoomlevelNumber, requestString, pictureFormat, GetMapTypeAsString());
            }

            if(image == null)
            {
                image = RequestBuilder.FindImage(requestString);
                _imageCache.SaveCacheImage(image, _zoomlevelNumber, requestString, pictureFormat, GetMapTypeAsString());
            }
        ...
        private void MultiTileDrawCore(BaseGeoCanvas canvas, BaseProjection projection, HEREMapsPictureFormat pictureFormat)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    resultImage.Compress(Bitmap.CompressFormat.Png, 0, stream); //Save(stream, GetMapImageFormat());
        ...
        private Bitmap.CompressFormat GetMapImageFormat()
        {
            switch (_pictureFormat)
            {
                ...
                /*case HEREMapsPictureFormat.Gif:
                    return Bitmap.CompressFormat.Gif;*/
        ...
        private static string GetTemporaryFolder()
        {
            ...
            if (string.IsNullOrEmpty(returnValue))
            {
                ...
                returnValue = System.IO.Path.Combine(basePath, "Temp");
            }
